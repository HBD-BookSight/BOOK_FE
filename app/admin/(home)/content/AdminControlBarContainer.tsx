...
import AdminContentForm, { AdminContentFormRef } from "@/components/popupProvider/adminForm/AdminContentForm";
...
const AdminControlBarContainer = () => {
  ...
  const ref = useRef<AdminContentFormRef>(null);

  const onClick = () => {
    openPopup(
      <AdminPopupModal>
        <AdminContentForm ref={ref} />
      </AdminPopupModal>,
      closePopup,
      () => {
