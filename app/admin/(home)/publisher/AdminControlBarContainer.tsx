...
import AdminPublisherForm, { AdminPublisherFormRef } from "@/components/popupProvider/adminForm/AdminPublisherForm";
...
const AdminControlBarContainer = () => {
  ...
  const ref = useRef<AdminPublisherFormRef>(null);

  const onClick = () => {
    openPopup(
      <AdminPopupModal>
        <AdminPublisherForm ref={ref} />
      </AdminPopupModal>,
      closePopup,
      () => {
