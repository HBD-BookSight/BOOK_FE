...
import { MOCK_EVENTS } from "@/public/data/mock_events";
...
const MainScheduleSlideDemo = async ({
  className,
  ...props
}: Readonly<Props>) => {
  return (
    ...
    >
      ...
      <Suspense fallback={<LoadingSpinner className="w-full" />}>
        <MainScheduleSlideContainer scheduleItems={MOCK_EVENTS} />
      </Suspense>
...
export default MainScheduleSlideDemo;
